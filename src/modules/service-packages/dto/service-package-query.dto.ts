...
export class ServicePackageQueryDto {
  ...
  @ApiPropertyOptional({ description: 'Số bản ghi mỗi trang, mặc định là 10', example: 10 })
  @IsOptional()
  @IsPositive()
  @Type(() => Number)
  limit?: number = 10;

  @ApiPropertyOptional({ description: 'Trường sắp xếp (name, price, durationMonths, createdAt, updatedAt)', example: 'createdAt' })
  @IsOptional()
  @IsString()
  ...
  @ApiPropertyOptional({ description: 'Từ khóa tìm kiếm trong tên', example: 'Basic' })
  @IsOptional()
  @IsString()
  search?: string;
  ...
  @ApiPropertyOptional({ description: 'Trạng thái hoạt động của gói dịch vụ', example: true })
  @IsOptional()
  @IsBoolean()
  @Type(() => Boolean)
  isActive?: boolean;
