...
@Module({
    imports: [
        TypeOrmModule.forFeature([ConsultantProfile, User, Role, Document]),
        AuthModule,
        FilesModule,
        MailModule,
        NotificationsModule,
    ...
    providers: [ConsultantProfilesService, ConsultantRegistrationService],
    exports: [ConsultantProfilesService],
})
