...
export class BlogAdminNotificationService {
    ...
    async triggerDailyPendingBlogsNotification() {
        this.logger.log('Triggering daily pending blogs report...');
        await this.adminBlogQueue.add(
    ...
    async triggerOverduePendingBlogsNotification() {
    ...
    async triggerWeeklyBlogStatistics() {
    ...
    async triggerMonthlyBlogStatistics() {
