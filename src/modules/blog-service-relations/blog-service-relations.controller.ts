...
export class BlogServiceRelationsController {
    constructor(
        private readonly blogServiceRelationsService: BlogServiceRelationsService,
    ) {}

    @Post()
    create(@Body() createBlogServiceRelationDto: CreateBlogServiceRelationDto) {
        return this.blogServiceRelationsService.create(
    ...
    update(
        @Param('id') id: string,
        @Body() updateBlogServiceRelationDto: UpdateBlogServiceRelationDto,
    ) {
        return this.blogServiceRelationsService.update(
            +id,
