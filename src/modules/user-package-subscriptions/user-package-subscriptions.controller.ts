...
export class UserPackageSubscriptionsController {
  ...
  @ApiResponse({ status: 201, description: 'User package subscription created successfully', type: CreateUserPackageSubscriptionDto })
  ...
  @ApiResponse({ status: 200, description: 'User package subscriptions retrieved successfully' })
  @ApiResponse({ status: 403, description: 'Forbidden: Only Staff, Manager, or Admin can perform this action' })
  ...
  @ApiResponse({ status: 200, description: 'User package subscription retrieved successfully', type: CreateUserPackageSubscriptionDto })
  @ApiResponse({ status: 400, description: 'Invalid subscription ID format' })
  @ApiResponse({ status: 404, description: 'User package subscription not found' })
  ...
  async findOne(
    @Param('id', new ParseUUIDPipe({
      exceptionFactory: () => new BadRequestException('Invalid subscription ID'),
    })) id: string,
  ) {
  ...
  @ApiResponse({ status: 200, description: 'User package subscription updated successfully', type: UpdateUserPackageSubscriptionDto })
  @ApiResponse({ status: 400, description: 'Invalid subscription ID format' })
  @ApiResponse({ status: 404, description: 'User package subscription not found' })
  @ApiResponse({ status: 403, description: 'Forbidden: Only Staff, Manager, or Admin can perform this action' })
  @ApiParam({ name: 'id', description: 'Subscription ID', type: String })
  ...
  @ApiResponse({ status: 200, description: 'User package subscription deleted successfully' })
  @ApiResponse({ status: 400, description: 'Invalid subscription ID format' })
  @ApiResponse({ status: 404, description: 'User package subscription not found' })
  ...
  @ApiResponse({ status: 200, description: 'User package subscription status retrieved successfully' })
  @ApiResponse({ status: 400, description: 'Invalid user ID format' })
  @ApiResponse({ status: 404, description: 'User not found or no active subscription' })
  @ApiResponse({ status: 403, description: 'Forbidden: Only Customer, Staff, Manager, or Admin can perform this action' })
